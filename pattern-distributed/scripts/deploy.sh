...
#${KUBECTL} create -f ../sp/wso2sp-receiver-extra-service.yaml
...
#${KUBECTL} create -f ../sp/wso2sp-worker-13-deployment.yaml
#${KUBECTL} create -f ../sp/wso2sp-worker-14-deployment.yaml
#${KUBECTL} create -f ../sp/wso2sp-worker-15-deployment.yaml
#${KUBECTL} create -f ../sp/wso2sp-worker-16-deployment.yaml
#${KUBECTL} create -f ../sp/wso2sp-worker-17-deployment.yaml
#${KUBECTL} create -f ../sp/wso2sp-worker-18-deployment.yaml
#${KUBECTL} create -f ../sp/wso2sp-worker-19-deployment.yaml
#${KUBECTL} create -f ../sp/wso2sp-worker-20-deployment.yaml
#${KUBECTL} create -f ../sp/wso2sp-worker-21-deployment.yaml
#${KUBECTL} create -f ../sp/wso2sp-worker-22-deployment.yaml
#${KUBECTL} create -f ../sp/wso2sp-worker-23-deployment.yaml
#${KUBECTL} create -f ../sp/wso2sp-worker-24-deployment.yaml
